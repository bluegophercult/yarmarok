...
func (m *MockRaffleStorage) Create(arg0 *service.Raffle) error {
	m.ctrl.T.Helper()
...
func (m *MockRaffleStorage) Get(arg0 string) (*service.Raffle, error) {
	m.ctrl.T.Helper()
...
func (m *MockRaffleStorage) GetAll() ([]service.Raffle, error) {
	m.ctrl.T.Helper()
...
func (m *MockRaffleStorage) ParticipantStorage(arg0 string) service.ParticipantStorage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParticipantStorage", arg0)
	ret0, _ := ret[0].(service.ParticipantStorage)
	return ret0
}
...
func (m *MockRaffleStorage) PrizeStorage(arg0 string) service.PrizeStorage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PrizeStorage", arg0)
	ret0, _ := ret[0].(service.PrizeStorage)
	return ret0
}
