...
func (m *MockOrganizerStorage) Create(arg0 *service.Organizer) error {
	m.ctrl.T.Helper()
...
func (m *MockOrganizerStorage) RaffleStorage(arg0 string) service.RaffleStorage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RaffleStorage", arg0)
	ret0, _ := ret[0].(service.RaffleStorage)
	return ret0
}
