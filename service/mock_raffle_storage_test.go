...
// ContributorStorage mocks base method.
func (m *MockRaffleStorage) ContributorStorage(arg0 string) ContributorStorage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ContributorStorage", arg0)
	ret0, _ := ret[0].(ContributorStorage)
	return ret0
}

// ContributorStorage indicates an expected call of ContributorStorage.
func (mr *MockRaffleStorageMockRecorder) ContributorStorage(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ContributorStorage", reflect.TypeOf((*MockRaffleStorage)(nil).ContributorStorage), arg0)
}
