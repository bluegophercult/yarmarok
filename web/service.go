...
type Service[T, I, O any] func(*http.Request) (T, error)
...
func (s Service[T, I, _]) Create(rw http.ResponseWriter, req *http.Request) {
	svc, err := extractService[T, Creator[I]](s, req)
	if err != nil {
		respondErr(rw, err)
		return
	}
...
func (s Service[T, _, O]) Get(rw http.ResponseWriter, req *http.Request) {
	svc, err := extractService[T, Getter[O]](s, req)
	if err != nil {
		respondErr(rw, err)
		return
	}
...
func (s Service[T, I, _]) Edit(rw http.ResponseWriter, req *http.Request) {
	svc, err := extractService[T, Editor[I]](s, req)
	if err != nil {
		respondErr(rw, err)
		return
	}
...
func (s Service[T, _, _]) Delete(rw http.ResponseWriter, req *http.Request) {
	svc, err := extractService[T, Deleter](s, req)
	if err != nil {
		respondErr(rw, err)
		return
	}
...
func (s Service[T, _, O]) List(rw http.ResponseWriter, req *http.Request) {
	svc, err := extractService[T, Lister[O]](s, req)
	if err != nil {
		respondErr(rw, err)
		return
	}
