...
//
//	mockgen -destination=mocks/mock_organizer.go -package=mocks github.com/kaznasho/yarmarok/service OrganizerService
//
...
func (mr *MockOrganizerServiceMockRecorder) CreateOrganizerIfNotExists(arg0 any) *gomock.Call {
...
func (mr *MockOrganizerServiceMockRecorder) RaffleService(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
